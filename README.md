...
running command...
$ prefab (--version)
@prefab-cloud/prefab/0.5.0-pre5 darwin-arm64 node-v22.12.0
$ prefab --help [COMMAND]
USAGE
  $ prefab COMMAND
...
...
_See code: [src/commands/create.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/create.ts)_
...
_See code: [src/commands/download.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/download.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/generate.ts)_
...
_See code: [src/commands/generate-new-hex-key.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/generate-new-hex-key.ts)_
...
_See code: [src/commands/get.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/get.ts)_
...
_See code: [src/commands/info.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/info.ts)_
...
_See code: [src/commands/interactive.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/interactive.ts)_
...
_See code: [src/commands/list.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/list.ts)_
...
_See code: [src/commands/override.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/override.ts)_
...
_See code: [src/commands/schema.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/schema.ts)_
...
_See code: [src/commands/serve.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/serve.ts)_
...
_See code: [src/commands/set-default.ts](https://github.com/prefab-cloud/prefab-cli/blob/v0.5.0-pre5/src/commands/set-default.ts)_
<!-- commandsstop -->
