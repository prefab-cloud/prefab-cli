...
describe('UnifiedPythonGenerator', () => {
  ...
  describe('Method generation', () => {
    it('should generate a method for a boolean type', () => {
      ...
      expect(methodCode).to.include('def is_feature_enabled(self, context: Optional[Union[dict, Context]] = None, default: Optional[bool] = None) -> bool:');
    ...
    it('should generate a method for a string type', () => {
      ...
      expect(methodCode).to.include('def get_api_url(self, context: Optional[Union[dict, Context]] = None, default: Optional[str] = None) -> str:');
      expect(methodCode).to.include('"""');
    ...
    it('should generate a method for a list of strings', () => {
      ...
      expect(methodCode).to.include('def get_allowed_domains(self, context: Optional[Union[dict, Context]] = None, default: Optional[List[str]] = None) -> List[str]:');
      expect(methodCode).to.include('"""');
  ...
  describe('Client generation', () => {
    it('should generate a client class with methods', () => {
      ...
      generator.registerMethod('is_feature_enabled', z.boolean(), 'FeatureFlag', [], 'Check if feature is enabled', 'BOOL');
